...
export const translations: Record<Lang, Dict> = {
  ...
  fr: {
    ...
    "why.title": "Cinق raisons de nous rendre visite",
  ...
  es: {
    ...
    "hero.subtitle": "Su refugio ideal en Bouyablane.",
    ...
    "about.p1": "Bienvenidos a Dar Diafa Zahi, su destino ideal para descubrir el encanto del Atlas Medio.",
    "about.p2": "Nuestro proyecto nació de nuestro deseo de ofrecer una auténtica experiencia de hospitalidad marroquí, combinando la sencillez de la vida en la montaña con la comodidad de una recepción genuina.",
    "about.p3": "Nuestro objetivo es proporcionar un refugio tranquilo para todo aquel que busque serenidad lejos del ruido de la ciudad, ya sea un amante del camping o un entusiasta del senderismo.",
    "services.kicker": "Servicios",
    "services.title": "Le invitamos a explorar nuestra casa de huéspedes",
    "services.rooms.title": "Calidez del lugar",
    "services.rooms.desc": "Una estancia confortable con un auténtico carácter montañoso que le brinda paz.",
    "services.table.title": "Generosidad de la mesa",
    "services.table.desc": "Descubra nuestros platos tradicionales cocinados con pasión y un toque familiar.",
    "services.adventure.title": "Espíritu de aventura",
    "services.adventure.desc": "Rutas de senderismo y exploración de los tesoros naturales que nos rodean.",
    "services.note": "Cada foto y video aquí es una invitación a una experiencia real e inolvidable.",
    "why.kicker": "Por qué elegirnos",
    "why.title": "Cinco razones para visitarnos",
    "why.1.title": "Ubicación estratégica",
    "why.1.desc": "En el corazón de Bouiblane, con vistas panorámicas y fácil acceso a las rutas.",
    ...
    "why.4.desc": "Esquí en invierno, camping en verano y exploración de cuevas.",
    ...
    "music.description": "Melodías del Atlas",
    "quran.title": "Espacio Coránico",
    "quran.subtitle": "Recitaciones tranquilas",
    "book.title": "¿Listo para la montaña?",
  ...
  de: {
    ...
    "hero.subtitle": "Ihr idealer Rückzugsort in Bouyablane.",
    ...
    "about.p1": "Willkommen im Dar Diafa Zahi, Ihrem idealen Ziel, um den Charme des Mittleren Atlas zu entdecken.",
    "about.p2": "Unser Projekt entstand aus dem Wunsch, ein authentisches marokkanisches Gastfreundschaftserlebnis zu bieten, das die Einfachheit des Berglebens mit dem Komfort herzlicher Aufnahme verbindet.",
    "about.p3": "Unser Ziel ist es, einen ruhigen Rückzugsort für alle zu bieten, die Ruhe abseits des Trubels der Stadt suchen, egal ob Sie Camping-Liebhaber oder Wanderbegeisterte sind.",
    "services.kicker": "Dienstleistungen",
    "services.title": "Erkunden Sie unser Gästehaus mit eigenen Augen",
    "services.rooms.title": "Wärme des Ortes",
    "services.rooms.desc": "Komfortabler Aufenthalt mit authentischem Bergcharakter für Ihre Ruhe.",
    "services.table.title": "Großzügigkeit des Tisches",
    "services.table.desc": "Entdecken Sie traditionelle Gerichte, die mit Leidenschaft und familiärer Note zubereitet werden.",
    "services.adventure.title": "Abenteuergeist",
    "services.adventure.desc": "Wanderwege und Erkundung der umliegenden Naturschätze.",
    "services.note": "Jedes Foto und Video hier ist eine Einladung zu einem echten Erlebnis.",
    "why.kicker": "Warum uns wählen",
    "why.title": "Fünf Gründe, uns zu besuchen",
    "why.1.title": "Strategische Lage",
    "why.1.desc": "Im Herzen von Bouiblane, Panoramablick und einfacher Zugang zu den Wanderwegen.",
    ...
    "why.3.desc": "Authentischer Berggeschmack mit frischen lokalen Produkten.",
    "why.4.title": "Vielfältige Aktivitäten",
    "why.4.desc": "Skifahren im Winter, Camping im Sommer und Erkundung von Höhlen.",
    "why.5.title": "Absolute Ruhe",
    "why.5.desc": "Idealer Ort für seelische Ruhe abseits des Großstadtlärms.",
    "testimonials.title": "Besucherstimmen",
    "music.mainTitle": "Audio-Lounge",
    "music.description": "Melodien aus dem Atlas",
    "quran.title": "Koran-Lounge",
    "quran.subtitle": "Beruhigende Rezitationen",
...
// مصفوفة الصور والفيديوهات (نضعها هنا لسهولة التعديل مستقبلاً)
